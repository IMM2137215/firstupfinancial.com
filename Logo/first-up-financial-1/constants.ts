...
export const NAV_ITEMS = [
  { view: AppView.HOME, label: 'Home', icon: ICONS.Home },
  { view: AppView.DASHBOARD, label: 'Dashboard', icon: ICONS.Chart },
  { view: AppView.SECONDARY_FREEZE, label: 'Freeze', icon: ICONS.Shield },
  { view: AppView.ANALYSIS, label: 'Analysis', icon: ICONS.Document },
